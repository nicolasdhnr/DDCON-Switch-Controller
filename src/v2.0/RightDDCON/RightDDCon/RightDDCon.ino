...
switchCommand current;
  ...
  // Define the error correction Parameters that are built into the DDCON.  
  const uint8_t rDelay = 2; //this is based on 250us increments, 0 is 250us so 7 is 2 ms
